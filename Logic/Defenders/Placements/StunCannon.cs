...
/*
 * The StunCannon behaves exactly like the BeamCannon, except that it stuns ships on hit
 * 
 * upgrades:
 * reloadTime
 * flightTime
 * damage
 * stunDuration (up to 5.5 seconds or something)
 * 
 */ 
public class StunCannon : MonoBehaviour {
